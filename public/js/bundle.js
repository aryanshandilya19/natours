    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          console.log('Signup error:', _t);
          message = ((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || _t.message || 'Error creating account';
...
var login = exports.login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(email, password) {
    var res, _err$response2, message, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          console.log('Login error:', _t2);
          message = ((_err$response2 = _t2.response) === null || _err$response2 === void 0 || (_err$response2 = _err$response2.data) === null || _err$response2 === void 0 ? void 0 : _err$response2.message) || _t2.message || 'Error logging in';
          (0, _alerts.showAlert)('error', message);
        case 3:
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var res, result, _err$response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          ...
          (0, _alerts.showAlert)('error', 'Stripe not initialized');
          return _context.a(2);
        case 1:
          _context.n = 2;
        ...
        case 2:
          ...
          (0, _alerts.showAlert)('error', 'No session returned from server');
          return _context.a(2);
        case 3:
          _context.n = 4;
        ...
        case 5:
          ...
          _t = _context.v;
          console.log(_t);
          (0, _alerts.showAlert)('error', ((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || _t.message || 'Error booking tour');
        case 6:
          return _context.a(2);
      }
    }, _callee, null, [[0, 5]]);
...
var photoLabel = document.querySelector('.form__photo-upload .form__label');
